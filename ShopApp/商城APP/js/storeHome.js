    ...
    var productList = document.getElementById('productlist'),
    	...
    	popsku = document.getElementById("pop-sku");
    var curpagesize = 10, curpageindex = 1, total = -1, lodeEnd = false, shopCategoryId = 0;
       ...
       mui('#dialogForbid').on('tap', 'div', function () {
        ...
        mui('#productlist').on('tap', 'li a', function() {
        	if(!this.getAttribute('data-isvirtual')){
        ...
        mui("#pop-sku").on('tap', '.comm-attr span', function() {
            ...
            selectedSku=skuId;
            var sctop = document.querySelector("#pop-sku .comm-bd").scrollTop;
            popsku.innerHTML = template('initSkuInfo',curSkuInfo);
            document.querySelector("#pop-sku .comm-bd").scrollTop = sctop;
        });
